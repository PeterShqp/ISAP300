...
;//           <2=> 32 bit
;//       </h>
EMCStaConfig2_Val   EQU 0x00000180
...
;//           <2=> 32 bit
;//       </h>
EMCStaConfig3_Val   EQU 0x00000181
...
;//           <i> The delay is in HCLK cycles
;//       </h>
EMCStaWaitTurn3_Val EQU 0x00000000
...
;//     </h>
EMCStaExtWait_Val   EQU 0x00000010
...
Vectors         LDR     PC,Reset_Addr         
		...
		import IRQ_Handler_RTX;lpc32xx_irq_handler;
		import SWI_Handler
...
IRQ_Handler     B       IRQ_Handler_RTX;IRQ_Handler;lpc32xx_irq_handler;
...
; Copy Exception Vectors to Internal RAM ---------------------------------------
				...
				;MOV 	SP, R0
				;import  sys_initial_intr_vec
                ;BL      sys_initial_intr_vec
                ENDIF
